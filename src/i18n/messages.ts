...
const zhTW = {
  ...
  loginTotp: {
    ...
    countdown: '驗證碼將在 {seconds} 秒後失效',
    codeRefreshed: '驗證碼已更新，請使用新的驗證碼',
  },
  loginVerify: {
    title: '二次驗證',
  ...
  accountList: {
    ...
    refreshBalance: '更新點數',
    memberCenter: '會員中心',
    memberCenterShort: '會員',
    customerService: '客服中心',
    customerServiceShort: '客服',
    gameStatus: '狀態',
    quickActions: '快捷操作',
    copyAccountId: '複製帳號ID',
    getOtp: '獲取OTP',
    copySuccess: '複製成功',
    copyFailed: '複製失敗',
    recyclingDesc: '清理遊戲快取檔案',
    playerReportDesc: '檢舉不當玩家行為',
    videoReportDesc: '檢舉違規影片內容',
    equipCalcDesc: '計算裝備星力需求',
    coreCalcDesc: '計算完美核心配置',
    autoPaste: '自動貼上',
    autoPasteTip:
    ...
    // 新增的键
    pathNotSet: '尚未設定路徑',
    pathNotSetDesc: '請先設定遊戲路徑才能啟動遊戲',
    setPath: '設定路徑',
    pathSetSuccess: '路徑設定成功',
    selectAccountFirst: '請先選擇帳號',
    otpCopied: 'OTP 已複製',
    otpFailed: '複製 OTP 失敗',
    gamePathNotSet: '遊戲路徑尚未設定',
    addAccountSuccess: '新增帳號成功',
    deleteAccountConfirm: '確定要刪除帳號 {name} 嗎？',
    deleteAccountSuccess: '刪除帳號成功',
    editAccountSuccess: '修改帳號成功',
    addAccount: '新增帳號',
    accountNamePlaceholder: '請輸入帳號名稱',
    clickToGetOtp: '點擊獲取 OTP',
    gettingOtp: '獲取中…',
    autoPasteOtp: '自動貼上 OTP',
    launchGame: '啟動遊戲',
    loadingGames: '載入遊戲中…',
    noGamesAdded: '尚未添加任何遊戲',
    addFirstGame: '添加第一個遊戲',
    addGame: '添加遊戲',
    accounts: '個帳號',
    noAccounts: '暫無帳號',
    // 游戏卡片头部按钮
    ...
    gameTools: '遊戲工具',
    settings: '設定',
    gameSettingsHint: '遊戲相關設定可在設定頁面中調整',
    goToSettings: '前往設定',
    gameLaunching: '正在啟動遊戲…',
    gameLaunchFailed: '啟動遊戲失敗',
    // 游戏设置弹窗
    characterName: '主要角色名稱',
    characterNamePlaceholder: '請輸入主要角色名稱（選填）',
    characterNameHint: '設定後可在卡片上顯示角色資訊',
    openTools: '開啟工具',
  },
  addGame: {
    title: '添加遊戲',
    selectGameAndPath: '請選擇遊戲並設定路徑',
    addSuccess: '添加遊戲成功',
    noAvailableGames: '沒有可用的遊戲',
    setPath: '設定遊戲路徑',
    pathPlaceholder: '請選擇遊戲執行檔路徑',
    browse: '瀏覽',
    pathHint: '請選擇遊戲的主要執行檔（.exe）',
    confirm: '確認添加',
  },
  addAccountDialog: {
  ...
  settings: {
    ...
    noGamesAdded: '尚未添加任何遊戲，請先從帳號列表頁面添加遊戲。',
    selectGame: '選擇遊戲',
    launchOptions: '啟動選項',
    tradLogin: '傳統登入模式',
    skipPlayWindow: '跳過 Play 視窗',
    preventAutoUpdate: '阻止自動更新',
    killPatcher: '阻止更新程式',
    saveSuccess: '儲存成功',
...
const zhCN = {
  ...
  loginTotp: {
    ...
    countdown: '验证码将在 {seconds} 秒后失效',
    codeRefreshed: '验证码已更新，请使用新的验证码',
  },
  loginVerify: {
    title: '二次验证',
  ...
  accountList: {
    ...
    refreshBalance: '刷新点数',
    memberCenter: '会员中心',
    memberCenterShort: '会员',
    customerService: '客服中心',
    customerServiceShort: '客服',
    gameStatus: '状态',
    quickActions: '快捷操作',
    copyAccountId: '复制账号ID',
    getOtp: '获取OTP',
    copySuccess: '复制成功',
    copyFailed: '复制失败',
    recyclingDesc: '清理游戏缓存文件',
    playerReportDesc: '举报不当玩家行为',
    videoReportDesc: '举报违规视频内容',
    equipCalcDesc: '计算装备星力需求',
    coreCalcDesc: '计算完美核心配置',
    autoPaste: '自动粘贴',
    autoPasteTip:
    ...
    // 新增的键
    pathNotSet: '尚未设定路径',
    pathNotSetDesc: '请先设定游戏路径才能启动游戏',
    setPath: '设定路径',
    pathSetSuccess: '路径设定成功',
    selectAccountFirst: '请先选择账号',
    otpCopied: 'OTP 已复制',
    otpFailed: '复制 OTP 失败',
    gamePathNotSet: '游戏路径尚未设定',
    addAccountSuccess: '新增账号成功',
    deleteAccountConfirm: '确定要删除账号 {name} 吗？',
    deleteAccountSuccess: '删除账号成功',
    editAccountSuccess: '修改账号成功',
    addAccount: '新增账号',
    accountNamePlaceholder: '请输入账号名称',
    clickToGetOtp: '点击获取 OTP',
    gettingOtp: '获取中…',
    autoPasteOtp: '自动贴上 OTP',
    launchGame: '启动游戏',
    loadingGames: '载入游戏中…',
    noGamesAdded: '尚未添加任何游戏',
    addFirstGame: '添加第一个游戏',
    addGame: '添加游戏',
    accounts: '个账号',
    noAccounts: '暂无账号',
    // 游戏卡片头部按钮
    ...
    gameTools: '游戏工具',
    settings: '设置',
    gameSettingsHint: '游戏相关设置可在设置页面中调整',
    goToSettings: '前往设置',
    gameLaunching: '正在启动游戏…',
    gameLaunchFailed: '启动游戏失败',
    // 游戏设置弹窗
    characterName: '主要角色名称',
    characterNamePlaceholder: '请输入主要角色名称（选填）',
    characterNameHint: '设定后可在卡片上显示角色资讯',
    openTools: '开启工具',
  },
  addGame: {
    title: '添加游戏',
    selectGameAndPath: '请选择游戏并设定路径',
    addSuccess: '添加游戏成功',
    noAvailableGames: '没有可用的游戏',
    setPath: '设定游戏路径',
    pathPlaceholder: '请选择游戏执行档路径',
    browse: '浏览',
    pathHint: '请选择游戏的主要执行档（.exe）',
    confirm: '确认添加',
  },
  addAccountDialog: {
  ...
  settings: {
    ...
    noGamesAdded: '尚未添加任何游戏，请先从账号列表页面添加游戏。',
    selectGame: '选择游戏',
    launchOptions: '启动选项',
    tradLogin: '传统登录模式',
    skipPlayWindow: '跳过 Play 窗口',
    preventAutoUpdate: '阻止自动更新',
    killPatcher: '阻止更新程序',
    saveSuccess: '保存成功',
    disableHardwareAccelerationTip:
...
const enUS = {
  ...
  loginTotp: {
    ...
    countdown: 'Code expires in {seconds} seconds',
    codeRefreshed: 'Code has been refreshed. Please use the new code.',
  },
  loginVerify: {
  ...
  accountList: {
    ...
    currentAccount: 'Current Game Account',
    ...
    recyclingDesc: 'Clean game cache files',
    playerReportDesc: 'Report inappropriate player behavior',
    videoReportDesc: 'Report violating video content',
    equipCalcDesc: 'Calculate equipment star force',
    coreCalcDesc: 'Calculate perfect core setup',
    ...
    // Game card header buttons
    gameSettings: 'Game Settings',
    gameTools: 'Game Tools',
    settings: 'Settings',
    gameSettingsHint: 'Game settings can be adjusted in the settings page',
    goToSettings: 'Go to Settings',
    gameLaunching: 'Launching game…',
    gameLaunchFailed: 'Failed to launch game',
    // Game settings dialog
    characterName: 'Main Character Name',
    characterNamePlaceholder: 'Enter main character name (optional)',
    characterNameHint: 'Character info will be displayed on the card after setting',
    openTools: 'Open Tools',
  },
  addGame: {
    title: 'Add Game',
    selectGameAndPath: 'Please select a game and set the path',
    addSuccess: 'Game added successfully',
    noAvailableGames: 'No available games',
    setPath: 'Set Game Path',
    pathPlaceholder: 'Please select the game executable path',
    browse: 'Browse',
    pathHint: 'Please select the main game executable (.exe)',
    confirm: 'Confirm Add',
  },
  addAccountDialog: {
  ...
  settings: {
    ...
    noGamesAdded: 'No games added yet. Please add games from the account list page.',
    selectGame: 'Select Game',
    launchOptions: 'Launch Options',
    tradLogin: 'Traditional Login',
    skipPlayWindow: 'Skip Play Window',
    preventAutoUpdate: 'Prevent Auto Update',
    killPatcher: 'Kill Patcher',
